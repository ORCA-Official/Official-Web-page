...
const Home = () => {
    ...
    return (
        <>
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between px-8 lg:px-16 py-12 space-y-8 lg:space-y-0">
                ...
                <ul className="grid grid-cols-2 gap-x-14 gap-y-2 pl-10">
                    {services.map((service, index) => (
                        <li key={index} className="flex items-center">
                            ...
                            <p className="text-md border-t border-b border-gray-400 py-2 w-full">
                                {service}
                            </p>
                        </li>
                    ))}
